...
enum SceneCatalog {
    ...
    static let all: [ForestScene] = [
        ...
        // ---- 追加2(実写・Unsplash) ----
        .init(id: "joseidaki", photoName: "photo-joseidaki", place: "広島・常清滝",
              info: "新緑と滝のしぶき", soundName: "ambient-river-falls", bucket: .day),
        .init(id: "kamikochi-autumn", photoName: "photo-kamikochi-autumn", place: "長野・上高地",
              info: "紅葉の峰と梓川", soundName: "ambient-stream-gentle", bucket: .day),
        .init(id: "minoo", photoName: "photo-minoo", place: "大阪・箕面大滝",
              info: "新緑の名瀑", soundName: "ambient-river-falls", bucket: .day),
        .init(id: "hakuba", photoName: "photo-hakuba", place: "長野・白馬",
              info: "秋の峰と雲", soundName: "ambient-forest-afternoon", bucket: .day),
        .init(id: "oshiraji", photoName: "photo-oshiraji", place: "栃木・おしらじの滝",
              info: "翡翠の滝壺", soundName: "ambient-river-falls", bucket: .day),
        .init(id: "nara-deer", photoName: "photo-nara-deer", place: "奈良・奈良公園",
              info: "木陰の鹿", soundName: "ambient-birds-evening", bucket: .dusk),
        .init(id: "nara-grassland", photoName: "photo-nara-grassland", place: "奈良・夏の草原",
              info: "夏草の丘と青空", soundName: "ambient-birds-spring", bucket: .day),
        // ---- 夕 ----
